  ...
  return (
    <div className={styles['rightBarWrapper']}>
      <div className={styles['rightBar']}>
        <IoCloseOutline
          size={30}
          className={styles['rightBar_closeIcon']}
          color="white"
        ...
        <img
          ...
          alt=""
          className={styles['rightBar_nftImage']}
        />
        <div className={styles['rightBar_index']}>
          <img
            src={data?.asset_contract?.image_url as string}
            alt=""
            className={styles['rightBar_userImage']}
          />
          <div>
            <p className={styles['rightBar_name']}>{data?.name}</p>
            <p className={styles['rightBar_owner']}>
        ...
        <a
          ...
          target="_blank"
          className={styles['rightBar_anchor']}
        >
